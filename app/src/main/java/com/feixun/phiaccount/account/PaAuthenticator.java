 ...
 */
class PaAuthenticator extends AbstractAccountAuthenticator {
    ...
    public PaAuthenticator(Context context) {
        super(context);
        mContext = context;
    }
...
//        final Intent intent = new Intent(mContext, LoginActivity.class);
        ...
        intent.setClass(mContext, PaWebViewActivity.class);
...
//        // return an error
//        if (!authTokenType.equals(PaAccountCons.AUTHTOKEN_TYPE)) {
...
//        //TODO:这个等全部完成了之后,处理下逻辑是跳到哪个界面等等
//        if (password != null) {
//            final String authToken = NetworkUtilities.authenticate(account.name, password);
//            if (!TextUtils.isEmpty(authToken)) {
//                final Bundle result = new Bundle();
//                result.putString(AccountManager.KEY_ACCOUNT_NAME, account.name);
//                result.putString(AccountManager.KEY_ACCOUNT_TYPE, PaAccountCons.ACCOUNT_TYPE);
...
//        final Intent intent = new Intent(mContext, LoginActivity.class);
//        intent.putExtra(AccountCons.PARAM_USERNAME, account.name);
//        intent.putExtra(AccountCons.PARAM_TOKEN, authTokenType);
//        intent.putExtra(AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE, response);
//        final Bundle bundle = new Bundle();
//        bundle.putParcelable(AccountManager.KEY_INTENT, intent);
//        return bundle;
    ...
    public Bundle hasFeatures(
        ...
        // This call is used to query whether the PaAuthenticator supports

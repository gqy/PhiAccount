...
public class PhiAlertController {
    ...
    public static int m_MyAlertContentViewId = R.layout.pafxlib_phialertdialog_layout;
    ...
    public PhiAlertController(Context context, DialogInterface di, Window window) {
        mContext = context;
        mDialogInterface = di;
        mWindow = window;
...
//        }
    ...
    private void setupView() {
        LinearLayout contentPanel = (LinearLayout) mWindow
                .findViewById(R.id.fxlib_phialertdialog_contentPanel);
        setupContent(contentPanel);
        boolean hasButtons = setupButtons();

        LinearLayout topPanel = (LinearLayout) mWindow
                .findViewById(R.id.fxlib_phialertdialog_topPanel);
        // TypedArray a = mContext.obtainStyledAttributes(
        // null, null, android.R.attr.alertDialogStyle, 0);
        TypedArray a = null;
        boolean hasTitle = setupTitle(topPanel);

        View buttonPanel = mWindow.findViewById(R.id.fxlib_phialertdialog_buttonPanel);
        if (!hasButtons) {
        ...
        if (mView != null) {
            customPanel = (FrameLayout) mWindow.findViewById(R.id.fxlib_phialertdialog_customPanel);
            FrameLayout custom = (FrameLayout) mWindow
                    .findViewById(R.id.fxlib_phialertdialog_custom);
            ...
            mWindow.findViewById(R.id.fxlib_phialertdialog_customPanel).setVisibility(View.GONE);
        }
    ...
    private boolean setupTitle(LinearLayout topPanel) {
        ...
        if (mCustomTitleView != null) {
            ...
            View titleTemplate = mWindow.findViewById(R.id.fxlib_phialertdialog_title_template);
            titleTemplate.setVisibility(View.GONE);
        } else {
            final boolean hasTextTitle = !TextUtils.isEmpty(mTitle);

            mIconView = (ImageView) mWindow.findViewById(R.id.fxlib_phialertdialog_icon);
            if (hasTextTitle) {

                /* Display the title if a title is supplied, else hide it */
                mTitleView = (TextView) mWindow.findViewById(R.id.fxlib_phialertdialog_alertTitle);
    ...
    private void setupContent(LinearLayout contentPanel) {
        mScrollView = (ScrollView) mWindow.findViewById(R.id.fxlib_phialertdialog_scrollView);
        mScrollView.setFocusable(false);

        // Special case for users that only want to display a String
        mMessageView = (TextView) mWindow.findViewById(R.id.fxlib_phialertdialog_message);
        if (mMessageView == null) {
            return;
        }
        ...
        if (mMessage != null) {
            ...
            if (mListView != null) {
                contentPanel.removeView(mWindow.findViewById(R.id.fxlib_phialertdialog_scrollView));
    ...
    private boolean setupButtons() {
        ...
        int whichButtons = 0;
        mButtonPositive = (Button) mWindow.findViewById(R.id.fxlib_phialertdialog_button1);
        mButtonNegative = (Button) mWindow.findViewById(R.id.fxlib_phialertdialog_button2);
        mButtonNeutral = (Button) mWindow.findViewById(R.id.fxlib_phialertdialog_button3);
        ...
        if (TextUtils.isEmpty(mButtonPositiveText)) {
            ...
            if (TextUtils.isEmpty(mButtonNegativeText)
                    && TextUtils.isEmpty(mButtonNeutralText)) {
                mButtonPositive
                        .setBackgroundResource(R.drawable.pafxlib_phialertdialog_btn_onebutton_bg);
            }
        }
        ...
        if (TextUtils.isEmpty(mButtonNeutralText)) {
            ...
            if (TextUtils.isEmpty(mButtonPositiveText)
                    && TextUtils.isEmpty(mButtonNegativeText)) {
                mButtonNeutral
                        .setBackgroundResource(R.drawable.pafxlib_phialertdialog_btn_onebutton_bg);
            }
        }
    ...
    private void setBackground(LinearLayout topPanel,
        ...
        int fullDark = R.drawable.pafxlib_phialertdialog_mid_bg;
        int topDark = R.drawable.pafxlib_phialertdialog_title_bg_no_divide_line;
        int centerDark = R.drawable.pafxlib_phialertdialog_mid_bg;
        int bottomDark = R.drawable.pafxlib_phialertdialog_buttonpanel;
        int fullBright = R.drawable.pafxlib_phialertdialog_mid_bg;
        int topBright = R.drawable.pafxlib_phialertdialog_title_bg_no_divide_line;
        int centerBright = R.drawable.pafxlib_phialertdialog_mid_bg;
        int bottomBright = R.drawable.pafxlib_phialertdialog_buttonpanel;
        int bottomMedium = R.drawable.pafxlib_phialertdialog_buttonpanel;
        ...
        boolean hasContentPanel=contentPanel.getVisibility()== View.GONE ? false:true;
        FrameLayout mCustomPanel=(FrameLayout) mWindow.findViewById(R.id.fxlib_phialertdialog_customPanel);
        boolean hasCustomPanel=mCustomPanel.getVisibility()== View.GONE ? false:true;
        LinearLayout mtitle= (LinearLayout) mWindow
                .findViewById(R.id.fxlib_phialertdialog_title_template);
        if(hasTitle && !hasContentPanel && !hasCustomPanel){
            mtitle.setBackgroundResource(topDark);
        }
        if(hasTitle && !hasButtons &&(hasContentPanel || hasCustomPanel)){
            mtitle.setBackgroundResource(topDark);
        }
    }
    ...
    public static class AlertParams {
        ...
        public void apply(PhiAlertController dialog) {
            if (mCustomTitleView != null) {
        ...
        private void createListView(final PhiAlertController dialog) {
            final RecycleListView listView = (RecycleListView) mInflater
                    .inflate(R.layout.pafxlib_phialertdialog_dialog, null);
            ListAdapter adapter;
            listView.setDivider(mContext.getDrawable(R.drawable.pafxlib_phialertdialog_list_divider));
            listView.setDividerHeight(mContext.getResources().getDimensionPixelSize(R.dimen.fxlib_phialertdialog_lsitview_divide_height));

            if (mIsMultiChoice) {
                if (mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(mContext,
                            R.layout.pafxlib_phialertdialog_multichoice,
                ...
                int layout = mIsSingleChoice ? R.layout.pafxlib_phialertdialog_singlechoice
                        : R.layout.pafxlib_phialertdialog_item;
                if (mCursor == null) {
